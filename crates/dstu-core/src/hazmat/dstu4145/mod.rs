...
//! arithmetic and the sign/verify logic itself are not implemented yet (see `docs/TASKS.md` Phase 2).
//! Citation for the field-arithmetic algorithms specifically: `docs/DECISIONS.md` D-25 (reduction
...
//! once implemented, is transcribed from Bouncy Castle's `DSTU4145Signer` per `docs/DECISIONS.md`
