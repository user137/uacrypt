...
- Curve domain-parameter tables beyond m=163 (`DSTU4145NamedCurves.java`, Annex Г's recommended
  ...
  core above. `m=257` specifically is now planned, not just enumerated by BC — see `docs/TASKS.md`
  T-199 / `docs/DECISIONS.md` D-185 for why (real Diia-issued certificates, not just the standard
  allowing it) and the domain parameters extracted from them.
