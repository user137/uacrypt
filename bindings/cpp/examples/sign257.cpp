// crypto_sign257 (DSTU 4145 m=257, T-199/T-204): both the success path and a rejected forgery,
// since a signature example that only shows the happy path doesn't demonstrate the primitive
...
int main() {
  auto signingKey = dstu::SigningKey257::Generate();
  ...
  std::cout << "signature257 verified OK\n";
