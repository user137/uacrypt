...
// bugprone-exception-escape flags every std::cout/cerr use in main (via ostream::operator<<'s own
// theoretical ios_base::failure, unrelated to this example's actual dstu::DstuException catch,
// confirmed with an isolated repro, not assumed) - inherent to any example that prints anything,
// not a real gap in the try/catch below.
